...
export default function Channel3(props) {
	...
	return(<div className="channel-3"><ChannelNumber number="3" />  First tech job and making a portfolio 	WOrking at Cart Designers
				Web Developer
...
-Sent AJAX API calls to pull third party data into the websites.</div>);
